...
builder.Services.AddSingleton<QueueService>(sp =>
{
    ...
    return new QueueService(connectionString, "ordersqueue"); // The queue name can be "ordersqueue" or any other name relevant to your application.
});
...
{
    var connectionString = configuration.GetConnectionString("AzureStorage");
    return new AzureFileShareService(connectionString, "contracts-logs"); // The share name can be "contracts-logs" or any other name relevant to your application.
});
